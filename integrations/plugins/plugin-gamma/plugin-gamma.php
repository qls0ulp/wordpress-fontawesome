 ...
 * Description:       Unregistered Client: tries to enqueue its own v4.7.0 webfont version from cdn.jsdelivr.net. It prepends a block before each blog post that displays an icon with "fa fa-bathtub", which is a version 4 specification that the v4shim should translate to "fas fa-bath". It also uses some pseudo-elements with a hardcoded version 4 font-family.
 * Version:           0.0.1
 * Author:            Font Awesome
